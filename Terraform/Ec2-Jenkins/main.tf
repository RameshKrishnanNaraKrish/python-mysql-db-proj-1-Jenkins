...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i /Users/nkrk1/Downloads/jenkinsdemo ubuntu@", aws_instance.jenkins_ec2_instance_ip.public_ip)
}
...
output "python_mysql_db_proj_1_ec2_instance_public_ip" {
